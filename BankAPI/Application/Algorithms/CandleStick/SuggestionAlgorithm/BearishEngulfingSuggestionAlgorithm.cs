...
{
    public class BearishEngulfingSuggestionAlgorithm : ICandleStickAlgorithm<Possibility[], Suggestion>
    {
        public Suggestion Calculate(Possibility[] possibilities)
        {
            return new Suggestion
            {
                ...
                Description = "Bearish Engulfing pattern seen, %" + possibilities.Last().Percentage + " decrease possibility.",
