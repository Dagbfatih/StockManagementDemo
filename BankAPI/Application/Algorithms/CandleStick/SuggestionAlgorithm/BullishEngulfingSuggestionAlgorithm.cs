...
{
    public class BullishEngulfingSuggestionAlgorithm : ICandleStickAlgorithm<Possibility[], Suggestion>
    {
        public Suggestion Calculate(Possibility[] possibilities)
        {
            return new Suggestion
            {
                ...
                Description = "Bullish Engulfing pattern seen, %" + possibilities.Last().Percentage + " increase possibility.",
